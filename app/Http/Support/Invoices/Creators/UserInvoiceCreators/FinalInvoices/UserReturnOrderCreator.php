<?php
/**
 * Create user return order invoice.
 */
...
class UserReturnOrderCreator extends StorageUserInvoiceCreator implements InvoiceCreatorInterface
{
    /**
    ...
    protected function getInvoiceData():array
    {
        return array_merge(parent::getInvoiceData(), [
            'invoice_types_id' => InvoiceTypes::USER_RETURN_ORDER,
        ]);
    }
