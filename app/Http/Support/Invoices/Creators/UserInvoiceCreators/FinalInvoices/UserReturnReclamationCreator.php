<?php
/**
 * Create user return reclamation invoice.
 */
...
class UserReturnReclamationCreator extends StorageUserInvoiceCreator implements InvoiceCreatorInterface
{
    /**
    ...
    protected function getInvoiceData():array
    {
        return array_merge(parent::getInvoiceData(), [
            'invoice_types_id' => InvoiceTypes::USER_RETURN_RECLAMATION,
        ]);
    }
