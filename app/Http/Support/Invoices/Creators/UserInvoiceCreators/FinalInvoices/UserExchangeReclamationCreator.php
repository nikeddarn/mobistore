<?php
/**
 * Create user exchange reclamation invoice.
 */
...
class UserExchangeReclamationCreator extends StorageUserInvoiceCreator implements InvoiceCreatorInterface
{
    /**
    ...
    protected function getInvoiceData():array
    {
        return array_merge(parent::getInvoiceData(), [
            'invoice_types_id' => InvoiceTypes::USER_EXCHANGE_RECLAMATION,
        ]);
    }
