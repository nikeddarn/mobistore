<?php
/**
 * Create vendor return reclamation invoice.
 */
...
class VendorReturnReclamationCreator extends StorageVendorInvoiceCreator implements InvoiceCreatorInterface
{
    /**
    ...
    protected function getInvoiceData():array
    {
        return array_merge(parent::getInvoiceData(), [
            'invoice_types_id' => InvoiceTypes::VENDOR_RETURN_RECLAMATION,
        ]);
    }
