<?php
/**
 * Create vendor delivery to shipment payment invoice.
 */
...
class VendorDeliveryToShipmentPaymentCreator extends VendorInvoiceCreator implements InvoiceCreatorInterface
{
    /**
    ...
    protected function getInvoiceData():array
    {
        return array_merge(parent::getInvoiceData(), [
            'invoice_types_id' => InvoiceTypes::VENDOR_DELIVERY_TO_SHIPMENT_PAYMENT,
        ]);
    }
