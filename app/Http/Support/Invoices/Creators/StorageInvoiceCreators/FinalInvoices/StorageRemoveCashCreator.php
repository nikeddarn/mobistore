<?php
/**
 * Create storage remove cash invoice.
 */
...
class StorageRemoveCashCreator extends StoragesInvoiceCreator implements InvoiceCreatorInterface
{
    /**
    ...
    protected function getInvoiceData():array
    {
        return array_merge(parent::getInvoiceData(), [
            'invoice_types_id' => InvoiceTypes::STORAGE_REMOVE_CASH,
        ]);
    }
}