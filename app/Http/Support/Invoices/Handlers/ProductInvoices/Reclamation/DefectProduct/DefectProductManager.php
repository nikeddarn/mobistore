...
class DefectProductManager extends ProductInvoiceManager
{
    /**
     ...
     * @return bool
     */
    private function addProductByReclamationId(int $reclamationId): bool
    {
        // create invoice defect product
     ...
     * @return bool
     */
    private function deleteProductFromInvoice(int $reclamationId): bool
    {
