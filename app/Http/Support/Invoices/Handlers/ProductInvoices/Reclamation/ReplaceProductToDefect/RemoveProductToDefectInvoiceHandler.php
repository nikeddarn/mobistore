...
final class RemoveProductToDefectInvoiceHandler extends ReplaceProductToDefectManager
{
    /**
    ...
    private function fixInvoiceInBalance(): bool
    {
        ...
        foreach ($this->getInvoiceProducts() as $reclamation) {
            ...
            // get storage product
            $storageProduct = $this->storageProductStockHandler->getStorageProduct($outgoingStorageDepartment, $reclamation->products_id);
