...
class SendUserOrderPartiallyCollectedNotifications implements UserRolesInterface, InvoiceTypes
{
    /**
     * @var User
     */
    ...
    public function handle($event)
    {
        ...
        $user->notify(new UserOrderPartiallyCollectedNotification($event->invoice));
    }
}
