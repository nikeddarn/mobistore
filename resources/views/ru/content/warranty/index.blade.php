...
@section('content')
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-sm-10">
                <p>При возникновении гарантийной ситуации оформите претензию по качеству товара на сайте в личном кабинете.</p>
                <p>Обмен товара с дефектом или товара, качество которого не соответствует заявленным характеристикам производится в течение 7 дней со дня получения нами данного товара.</p>
                <p>Если гарантийные условия нарушены - замена и возврат денег не производится. Данный товар возвращается покупателю за его счет.</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-4 pull-right">
                ...
                <p>Гарантийный срок на комплектующие к мобильным телефонам и планшетам - <strong>1&nbsp;месяц.</strong></p>
                <p>Для оптовых покупателей действует <strong>продленная&nbsp;гарантия</strong> по договоренности.</p>
                <p>Обмен или возврат денег осуществляется в течение <strong>7&nbsp;дней</strong> с момента возврата
                    товара.</p>
            </div>
            <div class="col-sm-8">
                <div class="underlined-title">
                ...
                <div class="panel panel-danger">
                    <div class="panel-body bg-danger">
                        ...
                        <p><strong>Убедительная просьба не пытаться устанавливать экраны и тачскрины
                                самостоятельно!</strong></p>
                        <p>При чрезмерном механическом воздействии контроллер экрана разрушается. Оборудование с такими
                            дефектами по гарантии не обслуживается.</p>
