...
@section('user_content')
    ...
    @include('content.user.orders.parts.title')

    <div class="m-t-3">
        @if($userOrders->count())
            @include('content.user.orders.parts.orders')
        @else
            <p class="text-indent">Нет заказов</p>
        @endif
    </div>
...
@section('breadcrumbs')
    @include('content.user.orders.parts.breadcrumbs')
@endsection

@section('user_menu')
    @include('menu.user_sidebar_menu', ['activeMenuItem' => 'user_orders'])
@endsection
