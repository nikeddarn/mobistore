...
@section('user_content')
    ...
    @include('content.user.messages.parts.title')

    <div class="m-t-3">
        @if($userMessages->count())
            @include('content.user.messages.parts.messages')
        @else
...
@section('breadcrumbs')
    @include('content.user.messages.parts.breadcrumbs')
@endsection

@section('user_menu')
    @include('content.user.messages.parts.user_menu')
@endsection
