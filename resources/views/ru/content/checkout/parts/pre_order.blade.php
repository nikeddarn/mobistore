<div class="table-responsive m-t-2">
    ...
    <table class="table table-bordered cart-product-list">
        ...
        @foreach($productsData['pre_order']['products'] as $product)
        ...
        <tr>
            ...
            <td colspan="2">
                <b class="pull-left">{{ $productsData['pre_order']['invoice_sum'] }}</b>
                <b class="pull-right invoice-uah-sum">{{ $productsData['pre_order']['invoice_uah_sum'] }}</b>
            </td>
        </tr>
        <tr>
            ...
            <td colspan="2">
                <b class="pull-right invoice-delivery-uah-sum"
                   data-post-delivery-text="{{ $productsData['pre_order']['post_delivery-message'] }}">{{ $productsData['pre_order']['delivery_uah_sum'] }}</b>
            </td>
        </tr>
        <tr>
            <td colspan="4" class="text-right border-top-none border-bottom-none border-left-none">Итого</td>
            <td colspan="2">
                <b class="pull-right invoice-uah-total-sum">{{ $productsData['pre_order']['total_uah_sum'] }}</b>
            </td>
        </tr>
