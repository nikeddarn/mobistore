    ...
    <div class="row">
        ...
        <div class="col-sm-8 col-md-6">
            <div class="input-group header-middle-item ">
                <input type="text" class="form-control header-middle-input header-middle-item-height" placeholder="Найти ...">
        ...
        <div class="col-sm-4 col-md-3 hidden-xs">
            <button type="button" class="btn btn-default dropdown-toggle header-middle-item header-middle-input header-middle-item-height" id="dropdown-cart" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
